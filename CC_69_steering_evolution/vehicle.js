...
function Vehicle(sketch, x, y, dna) {
  ...
  this.display = function() {
    ...
    if (debug.checked()) {
      ...
      this.s.noFill();
      this.s.line(0, 0, 0, -this.dna[0] * 25);
      this.s.strokeWeight(2);
      this.s.ellipse(0, 0, this.dna[2] * 2);
      this.s.stroke(255, 0, 0);
      this.s.line(0, 0, 0, -this.dna[1] * 25);
      this.s.ellipse(0, 0, this.dna[3] * 2);
    }

    var gr = this.s.color(0, 255, 0);
